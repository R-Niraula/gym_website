...
const About = () => {
    ...
    <> 
        ...
        <Coach className="coaches">
          <div className='gajju'><Img className="minor" src={Gajju} alt="Gajju" /><h3>Gajendra</h3></div>
          <div className='majorDiv'><Image className="major" src={Suresh} alt="Suresh" /><h3 className='sureshTxt'>Suresh</h3></div>
          <div><Img className="minor" src={Prashant} alt="Prashant" /><h3>Prashant</h3></div>
        </Coach>
        <br /><br />
